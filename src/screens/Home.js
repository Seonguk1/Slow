...
const HomeScreen = () => {
    ...
    return (
        ...
        >
            ...
            <Image source={arrowIcon} style={{ width: scaleWidth(89), height: scaleHeight(89) }} resizeMode="contain" />
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <MainIconBox
                        ...
                        image={babyIcon}
                        text={"우리아이\n이해하기"}
                        onPress={() => navigation.navigate("Test")} // Stack name 기준
                    />
                    <MainIconBox
                ...
                <View>
                    <FooterIconBox color={'rgba(255, 204, 102, 0.4)'} frontimage={profileIcon} backimage={arrowIcon} text={"JavaScript Avanzado"} time={"4시간 20분"} />
                    <FooterIconBox color={'rgba(69, 238, 226, 0.4)'} frontimage={profileIcon} backimage={arrowIcon} text={"JavaScript Avanzado"} time={"4시간 20분"} />
                </View>
            </View>
        </LinearGradient>
    );
